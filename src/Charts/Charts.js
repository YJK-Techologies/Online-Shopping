...
const ChartComponent = () => {
    ...
    const formatDate = (isoDateString) => {
     ...
     const aggregatePurchaseData = () => {
        ...
        purchaseChart.forEach(item => {
            const dateKey = (purchaseTimeRange === 'CFY' || purchaseTimeRange === 'last3Months' || purchaseTimeRange === 'lastYear') ? (item.MonthYear) : formatDate(item.bill_date);
    ...
    return (
        <div className="container-fluid">
            <div className="shadow-sm p-2 bg-body-tertiary rounded ms-1 mt-2 me-2 ps-4"><h2>Sales Report</h2></div>
            <div className="row shadow-sm p-2 bg-body-tertiary rounded mb-2 me-2 mt-2 ms-1 pt-4 me-1 row justify-content-end">
